...
import d from "../../public/assets/images/svg/arrow-left.svg"

const PropertyUploadSuccessModal = () => {
    return <div className="top-0 left-0 fixed z-[60] bg-white py-[130px] w-screen h-screen overflow-y-scroll px-20">
        ...
        <div className="w-[800px] mb-8 mx-auto text-center">
            ...
            <p className="text-[#555555] font-medium text-[28px]">Your Property has been successfully uploaded and would undergo verification </p>
        </div>
